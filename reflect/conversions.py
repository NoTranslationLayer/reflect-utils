...
def parse_metrics(
    ...
    Args:
        ...
        default_value (Any, optional): The default value to use if a metric is
            not recorded. Defaults to None.
...
def parse_reflection(
    reflection: Dict, default_value=None
    ...
    reflection_row = parse_metrics(reflection["metrics"], default_value)
...
def parse_json(
    ...
    for reflection in data:
        name, df = parse_reflection(reflection, default_value)

...
def main():
    ...
    An optional list of reflection names can be provided to filter which reflections to save.

    Command-line arguments:
    - json_path: Path to the JSON reflections file.
    - output_dir: Output directory for CSV files.
    - reflections: Optional list of reflection names to save. If not provided, all reflections will be saved.
    """
    ...
    reflections_map = conv.parse_json(json_string)
